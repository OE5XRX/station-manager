...
- docs/superpowers/specs/2026-09-03-audio-subsystem-design.md (Spec 0, NORMATIVE contract)
- docs/superpowers/specs/2026-09-05-audio-agent-component-design.md (this session's design)
"""
