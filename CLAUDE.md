...
- **SW + Manifest werden als Django-Views serviert** (nicht als Static Files), weil WhiteNoise Dateinamen durch Content-Hashing umbenennt — Browser erwarten exakt `/service-worker.js` und `/manifest.webmanifest`.
